...
export function AddEntryModal({
  ...
  const displayAmount = totalAmount > 0 ? formatMoney(totalAmount, currency) : "—";
        ...
        <div className="modal__body">
          ...
          <div className="amount-display-section">
            <div className="amount-display">
              <p className="amount-display__label">Total with currency</p>
              <p className="amount-display__value">{displayAmount}</p>
            </div>
            <label className="field">
              <span>Currency</span>
